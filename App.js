      ...
      {isChangeTimeOn && 
        ...
        <Counter count={this.parseTime(this.state.count)} />
          <View style={styles.menu}>
            <Button title={'Start'} color={'#26a65b'} onPress={this.startCount}></Button>
            <Button title={'Stop'} onPress={this.stopCount}></Button>
            <Button title={'Reset'} color={'#f7ca18'} onPress={this.resetCount}></Button>
            <Button title={'Set Time'} color={'#abb7b7'} onPress={this.changeTime}></Button>
          </View>
      </View>
    );
  }
